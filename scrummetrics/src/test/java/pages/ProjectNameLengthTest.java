...
public class ProjectNameLengthTest {
	...
	public void setUp() throws Exception {
		if (htmlreporter == null) {
			...
			test = reporter.createTest("Name Length", "Test de longitud del nombre");
		}
	...
	public void test() throws InterruptedException {
		...
		if (name.length() < 8 || name.length() > 64) {
			if (pc.isNameErrorDisplayed())
				test.log(Status.PASS, "Se mostró mensaje de error con longitud incorrecta");
			else
				test.log(Status.FAIL, "No se mostró mensaje de error");
