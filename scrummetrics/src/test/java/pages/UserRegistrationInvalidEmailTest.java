...
public class UserRegistrationInvalidEmailTest {
	...
	public void setUp() throws Exception {
		if (htmlreporter == null) {
			...
			test = reporter.createTest("Invalid Email", "Test de registrar perfil con email no valido");
		}
	...
	public void test() {
		...
		String alert = ur.userNotRegistered();
		if(alert.equals("Alert was not shown"))
			...
			test.log(Status.PASS, "Email reconocido como no valido");
		else
			test.log(Status.FAIL, "Error: Email no valido aceptado");
